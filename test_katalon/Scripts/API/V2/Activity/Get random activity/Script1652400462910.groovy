...
response = WS.sendRequest(findTestObject('API/V2/Activity/Get random activity'))
...
verify_activity = parsedJson.activity

verify_accessibility = parsedJson.accessibility

verify_type = parsedJson.type

verify_participants = parsedJson.participants

verify_price = parsedJson.price

verify_link = parsedJson.link

verify_key = parsedJson.key
