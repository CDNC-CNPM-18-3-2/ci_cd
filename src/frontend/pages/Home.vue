		...
		<div class="content">
			...
			<div class="hint">
				<p>Try a few others: <a
						@click="changeAndQuery('activity?type=recreational')">activity?type=recreational</a> <a
						@click="changeAndQuery('activity?participants=1')">activity?participants=1</a></p>
			</div>
			<div class="well">
				<pre>{{ response }}</pre>
			</div>
